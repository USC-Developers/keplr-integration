...
export class ValAddresses extends jspb.Message {
  ...
  clearAddressesList(): ValAddresses;
  addAddresses(value: string, index?: number): ValAddresses;
...
export class UnbondingDelegationEntry extends jspb.Message {
  ...
  clearCompletionTime(): UnbondingDelegationEntry;
...
export class RedelegationEntry extends jspb.Message {
  ...
  hasCompletionTime(): boolean;
  clearCompletionTime(): RedelegationEntry;
...
export class Params extends jspb.Message {
  ...
  setMinCommissionRate(value: string): Params;
...
export class RedelegationEntryResponse extends jspb.Message {
  ...
  clearRedelegationEntry(): RedelegationEntryResponse;
