...
export class MsgCreateValidator extends jspb.Message {
  ...
  clearDescription(): MsgCreateValidator;
  ...
  clearCommission(): MsgCreateValidator;
...
export class MsgEditValidator extends jspb.Message {
  ...
  hasDescription(): boolean;
  clearDescription(): MsgEditValidator;
...
export class MsgBeginRedelegate extends jspb.Message {
  ...
  hasAmount(): boolean;
  clearAmount(): MsgBeginRedelegate;
...
export class MsgBeginRedelegateResponse extends jspb.Message {
  ...
  clearCompletionTime(): MsgBeginRedelegateResponse;
...
export class MsgUndelegateResponse extends jspb.Message {
  ...
  hasCompletionTime(): boolean;
  clearCompletionTime(): MsgUndelegateResponse;
...
export class MsgCancelUnbondingDelegation extends jspb.Message {
  getDelegatorAddress(): string;
  setDelegatorAddress(value: string): MsgCancelUnbondingDelegation;

  getValidatorAddress(): string;
  setValidatorAddress(value: string): MsgCancelUnbondingDelegation;

  getAmount(): cosmos_base_v1beta1_coin_pb.Coin | undefined;
  setAmount(value?: cosmos_base_v1beta1_coin_pb.Coin): MsgCancelUnbondingDelegation;
  hasAmount(): boolean;
  clearAmount(): MsgCancelUnbondingDelegation;

  getCreationHeight(): number;
  setCreationHeight(value: number): MsgCancelUnbondingDelegation;
