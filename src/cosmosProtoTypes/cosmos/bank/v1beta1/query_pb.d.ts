...
export class QueryDenomOwnersRequest extends jspb.Message {
  getDenom(): string;
  setDenom(value: string): QueryDenomOwnersRequest;

  getPagination(): cosmos_base_query_v1beta1_pagination_pb.PageRequest | undefined;
  setPagination(value?: cosmos_base_query_v1beta1_pagination_pb.PageRequest): QueryDenomOwnersRequest;
  hasPagination(): boolean;
  clearPagination(): QueryDenomOwnersRequest;
...
export class DenomOwner extends jspb.Message {
  getAddress(): string;
  setAddress(value: string): DenomOwner;

  getBalance(): cosmos_base_v1beta1_coin_pb.Coin | undefined;
  setBalance(value?: cosmos_base_v1beta1_coin_pb.Coin): DenomOwner;
  hasBalance(): boolean;
  clearBalance(): DenomOwner;
...
export class QueryDenomOwnersResponse extends jspb.Message {
  ...
  setDenomOwnersList(value: Array<DenomOwner>): QueryDenomOwnersResponse;
  clearDenomOwnersList(): QueryDenomOwnersResponse;
  addDenomOwners(value?: DenomOwner, index?: number): DenomOwner;

  getPagination(): cosmos_base_query_v1beta1_pagination_pb.PageResponse | undefined;
  setPagination(value?: cosmos_base_query_v1beta1_pagination_pb.PageResponse): QueryDenomOwnersResponse;
  hasPagination(): boolean;
  clearPagination(): QueryDenomOwnersResponse;
