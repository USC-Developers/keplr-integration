...
export class QueryAllowancesByGranterRequest extends jspb.Message {
  getGranter(): string;
  setGranter(value: string): QueryAllowancesByGranterRequest;

  getPagination(): cosmos_base_query_v1beta1_pagination_pb.PageRequest | undefined;
  setPagination(value?: cosmos_base_query_v1beta1_pagination_pb.PageRequest): QueryAllowancesByGranterRequest;
  hasPagination(): boolean;
  clearPagination(): QueryAllowancesByGranterRequest;
...
export class QueryAllowancesByGranterResponse extends jspb.Message {
  getAllowancesList(): Array<cosmos_feegrant_v1beta1_feegrant_pb.Grant>;
  setAllowancesList(value: Array<cosmos_feegrant_v1beta1_feegrant_pb.Grant>): QueryAllowancesByGranterResponse;
  clearAllowancesList(): QueryAllowancesByGranterResponse;
  addAllowances(value?: cosmos_feegrant_v1beta1_feegrant_pb.Grant, index?: number): cosmos_feegrant_v1beta1_feegrant_pb.Grant;

  getPagination(): cosmos_base_query_v1beta1_pagination_pb.PageResponse | undefined;
  setPagination(value?: cosmos_base_query_v1beta1_pagination_pb.PageResponse): QueryAllowancesByGranterResponse;
  hasPagination(): boolean;
  clearPagination(): QueryAllowancesByGranterResponse;
