...
export class Result extends jspb.Message {
  ...
  setMsgResponsesList(value: Array<google_protobuf_any_pb.Any>): Result;
  clearMsgResponsesList(): Result;
...
export class TxMsgData extends jspb.Message {
  ...
  getMsgResponsesList(): Array<google_protobuf_any_pb.Any>;
  setMsgResponsesList(value: Array<google_protobuf_any_pb.Any>): TxMsgData;
  clearMsgResponsesList(): TxMsgData;
  addMsgResponses(value?: google_protobuf_any_pb.Any, index?: number): google_protobuf_any_pb.Any;
