...
export class SnapshotItem extends jspb.Message {
  ...
  setKv(value?: SnapshotKVItem): SnapshotItem;
  hasKv(): boolean;
  clearKv(): SnapshotItem;

  getSchema(): SnapshotSchema | undefined;
  setSchema(value?: SnapshotSchema): SnapshotItem;
  hasSchema(): boolean;
  clearSchema(): SnapshotItem;
...
export class SnapshotKVItem extends jspb.Message {
  ...
  getKey_asU8(): Uint8Array;
  getKey_asB64(): string;
  setKey(value: Uint8Array | string): SnapshotKVItem;

  getValue(): Uint8Array | string;
  getValue_asU8(): Uint8Array;
  getValue_asB64(): string;
  setValue(value: Uint8Array | string): SnapshotKVItem;
...
export class SnapshotSchema extends jspb.Message {
  ...
  setKeysList(value: Array<Uint8Array | string>): SnapshotSchema;
  clearKeysList(): SnapshotSchema;
  addKeys(value: Uint8Array | string, index?: number): SnapshotSchema;
