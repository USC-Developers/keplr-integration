...
export class QuerySubspacesResponse extends jspb.Message {
  ...
  setSubspacesList(value: Array<Subspace>): QuerySubspacesResponse;
  clearSubspacesList(): QuerySubspacesResponse;
...
export class Subspace extends jspb.Message {
  getSubspace(): string;
  setSubspace(value: string): Subspace;

  getKeysList(): Array<string>;
  setKeysList(value: Array<string>): Subspace;
  clearKeysList(): Subspace;
  addKeys(value: string, index?: number): Subspace;
