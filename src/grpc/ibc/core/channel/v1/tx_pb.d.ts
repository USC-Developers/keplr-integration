...
export class MsgChannelOpenInitResponse extends jspb.Message {
  getChannelId(): string;
  setChannelId(value: string): MsgChannelOpenInitResponse;

  getVersion(): string;
  setVersion(value: string): MsgChannelOpenInitResponse;
...
export class MsgChannelOpenTryResponse extends jspb.Message {
  getVersion(): string;
  setVersion(value: string): MsgChannelOpenTryResponse;
...
export class MsgRecvPacketResponse extends jspb.Message {
  getResult(): ResponseResultType;
  setResult(value: ResponseResultType): MsgRecvPacketResponse;
...
export class MsgTimeoutResponse extends jspb.Message {
  getResult(): ResponseResultType;
  setResult(value: ResponseResultType): MsgTimeoutResponse;
...
export class MsgTimeoutOnCloseResponse extends jspb.Message {
  getResult(): ResponseResultType;
  setResult(value: ResponseResultType): MsgTimeoutOnCloseResponse;
...
export class MsgAcknowledgementResponse extends jspb.Message {
  getResult(): ResponseResultType;
  setResult(value: ResponseResultType): MsgAcknowledgementResponse;
