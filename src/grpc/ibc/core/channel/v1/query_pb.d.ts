...
export class QueryPacketAcknowledgementsRequest extends jspb.Message {
  ...
  setPacketCommitmentSequencesList(value: Array<number>): QueryPacketAcknowledgementsRequest;
  clearPacketCommitmentSequencesList(): QueryPacketAcknowledgementsRequest;
  addPacketCommitmentSequences(value: number, index?: number): QueryPacketAcknowledgementsRequest;
