...
export class ClientUpdateProposal extends jspb.Message {
  ...
  setSubjectClientId(value: string): ClientUpdateProposal;

  getSubstituteClientId(): string;
  setSubstituteClientId(value: string): ClientUpdateProposal;
...
export class UpgradeProposal extends jspb.Message {
  ...
  setPlan(value?: cosmos_upgrade_v1beta1_upgrade_pb.Plan): UpgradeProposal;
  hasPlan(): boolean;
  clearPlan(): UpgradeProposal;

  getUpgradedClientState(): google_protobuf_any_pb.Any | undefined;
  setUpgradedClientState(value?: google_protobuf_any_pb.Any): UpgradeProposal;
  hasUpgradedClientState(): boolean;
  clearUpgradedClientState(): UpgradeProposal;
