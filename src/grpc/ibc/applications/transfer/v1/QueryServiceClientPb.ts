...
export class QueryClient {
  ...
  methodDescriptorDenomHash = new grpcWeb.MethodDescriptor(
    '/ibc.applications.transfer.v1.Query/DenomHash',
    grpcWeb.MethodType.UNARY,
    ibc_applications_transfer_v1_query_pb.QueryDenomHashRequest,
    ibc_applications_transfer_v1_query_pb.QueryDenomHashResponse,
    (request: ibc_applications_transfer_v1_query_pb.QueryDenomHashRequest) => {
      return request.serializeBinary();
    },
    ibc_applications_transfer_v1_query_pb.QueryDenomHashResponse.deserializeBinary
  );

  denomHash(
    request: ibc_applications_transfer_v1_query_pb.QueryDenomHashRequest,
    metadata: grpcWeb.Metadata | null): Promise<ibc_applications_transfer_v1_query_pb.QueryDenomHashResponse>;

  denomHash(
    request: ibc_applications_transfer_v1_query_pb.QueryDenomHashRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: ibc_applications_transfer_v1_query_pb.QueryDenomHashResponse) => void): grpcWeb.ClientReadableStream<ibc_applications_transfer_v1_query_pb.QueryDenomHashResponse>;

  denomHash(
    request: ibc_applications_transfer_v1_query_pb.QueryDenomHashRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: ibc_applications_transfer_v1_query_pb.QueryDenomHashResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/ibc.applications.transfer.v1.Query/DenomHash',
        request,
        metadata || {},
        this.methodDescriptorDenomHash,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
