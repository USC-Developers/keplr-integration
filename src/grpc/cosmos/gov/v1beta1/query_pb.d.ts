...
export class QueryProposalResponse extends jspb.Message {
  ...
  setProposal(value?: cosmos_gov_v1beta1_gov_pb.Proposal): QueryProposalResponse;
  hasProposal(): boolean;
...
export class QueryProposalsRequest extends jspb.Message {
  getProposalStatus(): cosmos_gov_v1beta1_gov_pb.ProposalStatus;
  setProposalStatus(value: cosmos_gov_v1beta1_gov_pb.ProposalStatus): QueryProposalsRequest;
...
export namespace QueryProposalsRequest {
  export type AsObject = {
    proposalStatus: cosmos_gov_v1beta1_gov_pb.ProposalStatus,
    voter: string,
    depositor: string,
...
export class QueryProposalsResponse extends jspb.Message {
  ...
  setProposalsList(value: Array<cosmos_gov_v1beta1_gov_pb.Proposal>): QueryProposalsResponse;
...
export class QueryVoteResponse extends jspb.Message {
  ...
  setVote(value?: cosmos_gov_v1beta1_gov_pb.Vote): QueryVoteResponse;
  hasVote(): boolean;
...
export class QueryVotesResponse extends jspb.Message {
  ...
  setVotesList(value: Array<cosmos_gov_v1beta1_gov_pb.Vote>): QueryVotesResponse;
...
export class QueryParamsResponse extends jspb.Message {
  ...
  setVotingParams(value?: cosmos_gov_v1beta1_gov_pb.VotingParams): QueryParamsResponse;
  ...
  setDepositParams(value?: cosmos_gov_v1beta1_gov_pb.DepositParams): QueryParamsResponse;
  ...
  setTallyParams(value?: cosmos_gov_v1beta1_gov_pb.TallyParams): QueryParamsResponse;
...
export class QueryDepositResponse extends jspb.Message {
  ...
  setDeposit(value?: cosmos_gov_v1beta1_gov_pb.Deposit): QueryDepositResponse;
  hasDeposit(): boolean;
...
export class QueryDepositsResponse extends jspb.Message {
  ...
  setDepositsList(value: Array<cosmos_gov_v1beta1_gov_pb.Deposit>): QueryDepositsResponse;
...
export class QueryTallyResultResponse extends jspb.Message {
  ...
  setTally(value?: cosmos_gov_v1beta1_gov_pb.TallyResult): QueryTallyResultResponse;
  hasTally(): boolean;
