...
export class GenesisState extends jspb.Message {
  ...
  setDepositsList(value: Array<cosmos_gov_v1beta1_gov_pb.Deposit>): GenesisState;
  ...
  setVotesList(value: Array<cosmos_gov_v1beta1_gov_pb.Vote>): GenesisState;
  ...
  setProposalsList(value: Array<cosmos_gov_v1beta1_gov_pb.Proposal>): GenesisState;
