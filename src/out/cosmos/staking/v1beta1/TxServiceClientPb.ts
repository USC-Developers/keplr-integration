...
export class MsgClient {
  ...
  methodDescriptorCancelUnbondingDelegation = new grpcWeb.MethodDescriptor(
    '/cosmos.staking.v1beta1.Msg/CancelUnbondingDelegation',
    grpcWeb.MethodType.UNARY,
    cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegation,
    cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegationResponse,
    (request: cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegation) => {
      return request.serializeBinary();
    },
    cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegationResponse.deserializeBinary
  );

  cancelUnbondingDelegation(
    request: cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegation,
    metadata: grpcWeb.Metadata | null): Promise<cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegationResponse>;

  cancelUnbondingDelegation(
    request: cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegation,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegationResponse) => void): grpcWeb.ClientReadableStream<cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegationResponse>;

  cancelUnbondingDelegation(
    request: cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegation,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: cosmos_staking_v1beta1_tx_pb.MsgCancelUnbondingDelegationResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/cosmos.staking.v1beta1.Msg/CancelUnbondingDelegation',
        request,
        metadata || {},
        this.methodDescriptorCancelUnbondingDelegation,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
