...
export class QueryCurrentPlanResponse extends jspb.Message {
  ...
  setPlan(value?: cosmos_upgrade_v1beta1_upgrade_pb.Plan): QueryCurrentPlanResponse;
  hasPlan(): boolean;
  clearPlan(): QueryCurrentPlanResponse;
...
export class QueryAppliedPlanRequest extends jspb.Message {
  getName(): string;
  setName(value: string): QueryAppliedPlanRequest;
...
export class QueryAppliedPlanResponse extends jspb.Message {
  getHeight(): number;
  setHeight(value: number): QueryAppliedPlanResponse;
...
export class QueryUpgradedConsensusStateRequest extends jspb.Message {
  ...
  setLastHeight(value: number): QueryUpgradedConsensusStateRequest;
...
export class QueryUpgradedConsensusStateResponse extends jspb.Message {
  ...
  setUpgradedConsensusState(value: Uint8Array | string): QueryUpgradedConsensusStateResponse;
...
export class QueryModuleVersionsRequest extends jspb.Message {
  ...
  setModuleName(value: string): QueryModuleVersionsRequest;
...
export class QueryModuleVersionsResponse extends jspb.Message {
  ...
  setModuleVersionsList(value: Array<cosmos_upgrade_v1beta1_upgrade_pb.ModuleVersion>): QueryModuleVersionsResponse;
  clearModuleVersionsList(): QueryModuleVersionsResponse;
...
export class QueryAuthorityResponse extends jspb.Message {
  getAddress(): string;
  setAddress(value: string): QueryAuthorityResponse;
