...
export class ServiceClient {
  ...
  methodDescriptorABCIQuery = new grpcWeb.MethodDescriptor(
    '/cosmos.base.tendermint.v1beta1.Service/ABCIQuery',
    grpcWeb.MethodType.UNARY,
    cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest,
    cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse,
    (request: cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest) => {
      return request.serializeBinary();
    },
    cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse.deserializeBinary
  );

  aBCIQuery(
    request: cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest,
    metadata: grpcWeb.Metadata | null): Promise<cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse>;

  aBCIQuery(
    request: cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse) => void): grpcWeb.ClientReadableStream<cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse>;

  aBCIQuery(
    request: cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: cosmos_base_tendermint_v1beta1_query_pb.ABCIQueryResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/cosmos.base.tendermint.v1beta1.Service/ABCIQuery',
        request,
        metadata || {},
        this.methodDescriptorABCIQuery,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
